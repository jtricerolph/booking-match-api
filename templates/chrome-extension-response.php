<?php
/**
 * Chrome Extension Response Template
 *
 * HTML template for chrome-extension context
 *
...
?>
<div class="bma-result" data-search-method="<?php echo esc_attr($search_method); ?>">
        ...
        <div class="bma-booking-summary">
            ...
            <div class="bma-summary-content">
                <div class="bma-summary-row">
                    ...
                    <span class="bma-muted">Room <?php echo esc_html($booking['room']); ?> • #<?php echo esc_html($booking['booking_id']); ?></span>
                </div>
                <div class="bma-summary-row">
                    <span class="bma-muted">
                        <?php
                ...
                <div class="bma-night <?php echo $has_matches ? 'matched' : 'unmatched'; ?> <?php echo $has_warnings ? 'has-warnings' : ''; ?> <?php echo $has_package_alert ? 'has-package-alert' : ''; ?>">
                    <div class="bma-night-header">
                        <div class="bma-night-date">
                            <?php echo esc_html(date('D, d/m/y', strtotime($night['date']))); ?>
                        </div>
                        <?php if ($has_package_alert): ?>
                            <span class="bma-package-alert-badge">🍽️</span>
                        <?php elseif ($has_warnings): ?>
                            <span class="bma-warning-badge">⚠</span>
                        <?php endif; ?>
                    </div>
                    ...
                    <?php if ($has_matches): ?>
                        <?php if ($match_count > 1): ?>
                            <div class="bma-night-status matched multiple">
                                ...
                                <span><?php echo $match_count; ?> restaurant bookings found</span>
                            </div>
                        <?php else: ?>
